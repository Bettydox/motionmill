...
function motionmill_mail_templates_add_templates($templates)
{
	...
	(
		'title'       => __( 'User notification', Motionmill::TEXTDOMAIN ),
		'description' => __( 'Notify the blog admin of a new user.', Motionmill::TEXTDOMAIN ),
		'fields'      => array
		(
			'from' 	      => null,
	...
	(
		'title'       => __( 'User Confirmation', Motionmill::TEXTDOMAIN ),
		'description' => __( 'Send an email with login/password to the new user.', Motionmill::TEXTDOMAIN ),
		'fields'      => array
		(
			'from' 	      => null,
			'to' 		  => '[user:user_email]',
	...
	(
		...
		'description' => __( 'Send a copy of password change notification to the admin.', Motionmill::TEXTDOMAIN ),
		'fields'      => array
		(
			'from' 	      => null,
			'to' 		  => get_option('admin_email'),
	...
	(
		'title'       => __( 'Retrieve Password', Motionmill::TEXTDOMAIN ),
		'description' => __( 'This mail will be send to the user who wants to reset his/her password.', Motionmill::TEXTDOMAIN ),
		'fields'      => array
		(
			'from' 	      => null,
			'to' 		  => null,
